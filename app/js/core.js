...
export const FEATURES = [
  ...
  { id: "oral-exam", title: "Oral Exam - Premium", route: "#/training/oral-exam", requires: "AI_TRAINER", status: "available", desc: "AI examiner for check-ride preparation, through the session-gated /api/ai/oral-exam proxy. Grounded in this app's own bundled decks: the examiner is given the authored material and its approved answers, and is instructed never to state a figure that is not in it. Up to 12 questions a session; nothing is saved." },
