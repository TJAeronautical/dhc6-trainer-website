...
export const FEATURES = [
  ...
  { id: "study", title: "Study / Knowledge", route: "#/knowledge/home", status: "partial", desc: "Study home with Search, Library and Knowledge tiles (StudyHomeScreen). Every tile carries its own status. One is not Available: Flashcards is read-only browse, because the review / approve / edit lanes are authoring tools that stay in the Android app." },
