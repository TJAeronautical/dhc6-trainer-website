...
export const FEATURES = [
  ...
  { id: "study", title: "Study / Knowledge", route: "#/knowledge/home", status: "partial", desc: "Study home with Search, Library and Knowledge tiles (StudyHomeScreen). Every tile carries its own status; the two that are not Available are Search (does not yet cover Library documents) and Flashcards (read-only browse — the review/approve/edit lanes are authoring tools and stay app-only)." },
  { id: "search", title: "Search", route: "#/knowledge/search", status: "partial", desc: "Searches bundled knowledge units, procedures and definitions. Documents uploaded to the Library are not searched yet." },
  ...
  { id: "import", title: "Import", route: "#/library/import", status: "later", desc: "Android's PDF text-extraction pipeline (PdfImportViewModel, QrhCandidateExtractor) turning a manual into draft procedures and knowledge cards in Room. Uploading a document to read it is on Library -> Sources." },
